...
class _DashbaordScreenState extends State<DashbaordScreen> {
  ...
  void _fetchDashboardData() {
    // Get date range based on selectedDateRange
    ...
    // Dispatch the event to fetch dashboard data
  ...
  void _printValues() {
    ...
    print(
        "Start Date: ${startDate != null ? _formatDate(startDate) : "Not selected"}");
    print(
        "End Date: ${endDate != null ? _formatDate(endDate) : "Not selected"}");
  }
            ...
            BlocBuilder<DashboardBloc, DashboardState>(
              builder: (context, state) {
                if (state is DashboardLoading) {
                  return Expanded(
                    child: DashboardShimmer.dashboardShimmer(context),
                  );
                  ...
                  // Access nested data using safe navigation
                  final salesSummary =
                      data['salesSummary'] as Map<String, dynamic>? ?? {};
                  final purchaseSummary =
                      data['purchaseSummary'] as Map<String, dynamic>? ?? {};
                  final otherIncomeExpense =
                      data['otherIncomeExpense'] as Map<String, dynamic>? ?? {};
                  final stockSummary =
                      data['stockSummary'] as Map<String, dynamic>? ?? {};
                  final balanceSheet =
                      data['balanceSheet'] as Map<String, dynamic>? ?? {};
                            ...
                            return Row(
                              children: [
                                FinacialOverview(
                                  ...
                                  title: 'Net Sales',
                                  cost: formatter
                                      .format(salesSummary['netSales'] ?? 0.0),
                                  iconPath: 'assets/icons/netsale.png',
                                  color: Color(0xFF1976D2),
                                  viewMoreText: 'View More',
                                  cardType: FinancialCardType.netSales,
                                  data: salesSummary,
                                ),
                                SizedBox(width: 10),
                                ...
                                FinacialOverview(
                                  ...
                                  cost: formatter.format(
                                      salesSummary['profitAfterDiscount'] ??
                                          0.0),
                                  iconPath: 'assets/icons/netprofit.png',
                                  color: Color(0xFF2E7D32),
                                  viewMoreText: 'View More',
                                  cardType: FinancialCardType.netProfit,
                                  data: salesSummary,
                                ),
                                SizedBox(width: 10),
                                ...
                                FinacialOverview(
                                  ...
                                  title: 'Net Purchase',
                                  cost: formatter.format(
                                      purchaseSummary['netPurchase'] ?? 0.0),
                                  iconPath: 'assets/icons/netpurchase.png',
                                  color: Color(0xFFD8A713),
                                  viewMoreText: 'View More',
                                  cardType: FinancialCardType.netPurchase,
                                ...
                                FinacialOverview(
                                  ...
                                  title: 'Other Income',
                                  cost: formatter.format(
                                      otherIncomeExpense['otherIncome'] ?? 0.0),
                                  iconPath: 'assets/icons/income.png',
                                  color: Color(0xFFFF9800),
                                  viewMoreText: 'View More',
                                  cardType: FinancialCardType.otherIncome,
                                ...
                                FinacialOverview(
                                  ...
                                  cost: formatter.format(
                                      otherIncomeExpense['otherExpenses'] ??
                                          0.0),
                                  iconPath: 'assets/icons/expences.png',
                                  color: Color(0xFFD32F2F),
                                  viewMoreText: 'View More',
                                  cardType: FinancialCardType.otherExpenses,
                                  data: otherIncomeExpense,
                                ),
                                SizedBox(width: 10),
                                ...
                                FinacialOverview(
                                  ...
                                  title: 'Stock Value',
                                  cost: formatter
                                      .format(stockSummary['costValue'] ?? 0.0),
                                  iconPath: 'assets/icons/stock.png',
                                  color: Color(0xFF9C27B0),
                                  viewMoreText: 'View More',
                                  cardType: FinancialCardType.stockValue,
                                  data: stockSummary,
                                ),
                              ],
                            );
                ...
                // Initial state or fallback with shimmer
                return Expanded(
                  child: DashboardShimmer.dashboardShimmer(context),
                );
              },
  ...
  Column filterOption(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Date From & Date To only show if "Custom" is selected
        if (selectedDateRange == "Custom")
          Row(
            children: [
              Expanded(
  ...
  Widget _buildAmountCards(Map<String, dynamic> balanceSheet) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        List<Widget> cards = [
          _buildAmountCard('assets/icons/paybaleamount.png', 'Amount Payable',
              balanceSheet['amountPayable'] ?? 0.0, Color(0xFFD43434)),
          _buildAmountCard(
              'assets/icons/receivable.png',
              'Amount Receivable',
              balanceSheet['amountReceivable'] ?? 0.0,
              Color.fromARGB(255, 96, 187, 114)),
          _buildAmountCard('assets/icons/chqpayable.png', 'CHQ Payable',
              balanceSheet['chqPayable'] ?? 0.0, Color(0xFFD43434)),
          _buildAmountCard(
              'assets/icons/chqreceiavble.png',
              'CHQ Receivable',
              balanceSheet['chqReceivable'] ?? 0.0,
              Color.fromARGB(255, 96, 187, 114)),
        ];
  ...
  Widget _buildAmountCard(
      String icon, String title, double amount, Color color) {
    final formatter = NumberFormat("#,##0.00", "en_US");
